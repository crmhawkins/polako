...
class AsociadosCategoriesTable extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.asociados-categories-table', [
    ...
    protected function actualizarServiciosCategoria()
    {
        ...
        $query = CategoriaGastosAsociados::when($this->buscar, function ($query) {
