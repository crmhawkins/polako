    ...
    <div class="page-title card-body">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Editar banco</h3>
                <p class="text-subtitle text-muted">Formulario para editar un banco</p>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input placeholder="Nombre de la banco" type="text" class="form-control @error('name') is-invalid @enderror" id="name" value="{{ old('name',$banco->name) }}" name="name">
                                    @error('name')
