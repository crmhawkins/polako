             ...
             <table class="table table-hover">
                ...
                <tbody>
                    @foreach ( $orders as $order )
                        <tr class="clickable-row" data-href="{{ route('tpv.edit', $order->id) }}">
                            <td>{{$order->numero}}</td>
                            <td>{{$order->total }}</td>
                            <td class="d-flex flex-row justify-evenly align-middle">
                                <a class="m-2" href="{{route('tpv.edit', $order->id)}}"><img src="{{asset('assets/icons/edit.svg')}}" alt="Editar dominio"></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
